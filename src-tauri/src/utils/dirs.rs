...
pub static APP_ID: &str = "uk.bluelayer.client";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "bluelayer-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "uk.bluelayer.client.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "bluelayer-backup-dev";
...
pub static SERVICE_BINARY_NAME: &str = "bluelayer-mihomo-service";
pub static SERVICE_INSTALL_NAME: &str = "bluelayer-mihomo-service-install";
pub static SERVICE_UNINSTALL_NAME: &str = "bluelayer-mihomo-service-uninstall";
...
pub fn service_path() -> Result<PathBuf> {
    ...
    Ok(res_dir.join(SERVICE_BINARY_NAME))
}

#[cfg(windows)]
pub fn service_path() -> Result<PathBuf> {
    let res_dir = app_resources_dir()?;
    Ok(res_dir.join(format!("{SERVICE_BINARY_NAME}.exe")))
}
...
pub fn ipc_path() -> Result<PathBuf> {
    Ok(PathBuf::from(format!(r"\\.\pipe\{}-mihomo", app_namespace())))
}
#[async_trait]
